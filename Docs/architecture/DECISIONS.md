...
The project handbook is the governing specification for the Feature Detection Engine.

Architectural changes must be documented and agreed before implementation begins.
